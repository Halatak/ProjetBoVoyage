...
import fr.adaming.controller.PanierController;

public class MailDeux {
	public static void send(String from, String password, String to, String sub, String msg) {
		...
		try {
			...
			// Pièces jointes
			String chemin = "C:\\Users\\IN-BR-006\\PDFVoyage\\FicheVoyage"
					+ Integer.toString(PanierController.getNumero()) + ".pdf";
			...
			partieMessage.setFileName("Dossier.pdf");
			multipart.addBodyPart(partieMessage);
