...
public class PayPalResult {
	...
	private String transactio_subject;
	...
	public String getAdress_status() {
		return adress_status;
	}
	public void setAdress_status(String adress_status) {
		this.adress_status = adress_status;
	}
	...
	public String getTransactio_subject() {
		return transactio_subject;
	}
	public void setTransactio_subject(String transactio_subject) {
		this.transactio_subject = transactio_subject;
	}
