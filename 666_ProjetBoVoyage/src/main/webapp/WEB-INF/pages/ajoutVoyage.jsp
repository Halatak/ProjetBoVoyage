...
<form:form cssClass="form-horizontal" method="post" action="soumettreVoyageAdd" commandName="vAjout">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-5">
      <form:input type="date" cssClass="form-control" id="idDateDepart" path="dateDepart" placeholder="Date de départ"/>
    </div>
  </div>
  <div class="form-group">
    <label for="idDateArrive" class="col-sm-2 control-label">Date d'arrivé</label>
    <div class="col-sm-5">
      <form:input type="date" cssClass="form-control" id="idDateArrive" path="dateArrive" placeholder="Date d'arrivé"/>
    </div>
  </div>
    <div class="form-group">
